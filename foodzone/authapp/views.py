    ...
    if request.method=="POST":
        ...
        try:
            if User.objects.get(username=email):
                 #return HttpResponse("email alredy exist")
                 messages.info(request,"Alrdy have A Email is Taken")
                 return render(request,'signup.html')
        ...
        # [email])
        # email_message.send()
        messages.success(request,f"Active Your Account by clicking the link in your gmail {message}")
